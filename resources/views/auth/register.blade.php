...
<div class="container">
 ...
 --}}
                                <select name="gender" type="text" id="name" class="form-control @error('gender') is-invalid @enderror" value="{{ old('gender') }}" required autocomplete="gender" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" placeholder="(+91) 8580527175" type="text" class="form-control @error('contact') is-invalid @enderror" name="contact" value="{{ old('contact') }}" required autocomplete="name" autofocus>
